# Contributing to frictionless

This outlines how to propose a change to frictionless.
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("frictionlessdata/frictionless-r", fork = TRUE)`.
...
Please note that the frictionless project is released with a
[Contributor Code of
Conduct](https://frictionlessdata.io/work-with-us/code-of-conduct/). By
