...
- [`upgrade_package()`](https://docs.ropensci.org/frictionless/reference/upgrade_package.md)
  can be used to upgrade a package, its resources and verbose schemas
  from v1 to v2 (harmonizing mixed versions)
  ([\#376](https://github.com/frictionlessdata/frictionless-r/issues/376),
