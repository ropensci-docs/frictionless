...
- [`upgrade_package()`](https://docs.ropensci.org/frictionless/reference/upgrade_package.md)
  set `$schema` to the recommended v2 value for all resources of a
  package.
...
[`add_resource()`](https://docs.ropensci.org/frictionless/reference/add_resource.md).
[`upgrade_package()`](https://docs.ropensci.org/frictionless/reference/upgrade_package.md)
removes `profile` (unless `$schema` is already set), but converts
`"profile" = "tabular-data-resource"` to `"type" = "table"` (see
[backwards
