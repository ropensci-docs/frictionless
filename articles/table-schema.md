...
- [`upgrade_package()`](https://docs.ropensci.org/frictionless/reference/upgrade_package.md)
  sets `$schema` to the recommended v2 value for all resources of a
  package.
...
[`create_schema()`](https://docs.ropensci.org/frictionless/reference/create_schema.md).
[`upgrade_package()`](https://docs.ropensci.org/frictionless/reference/upgrade_package.md)
converts single values to an array (see
...
[`create_schema()`](https://docs.ropensci.org/frictionless/reference/create_schema.md).
[`upgrade_package()`](https://docs.ropensci.org/frictionless/reference/upgrade_package.md)
converts single values in `fields` to an array and removes
`reference$resource` if it is self-referential (see
